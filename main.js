...
var $author$project$Main$initialBom = {name: '', uuid: ''};
var $author$project$Main$initialItem = {bomUuid: '', link: '', name: '', price: 0, qty: 0, uuid: ''};
...
var $author$project$Main$init = function (seed) {
	...
	return _Utils_Tuple2(
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					$author$project$Main$idbGet('boms'),
					$author$project$Main$idbGet('items')
				])));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'uuid',
				$elm$json$Json$Encode$string(bom.uuid)),
				_Utils_Tuple2(
				'name',
				$elm$json$Json$Encode$string(bom.name))
			]));
};
var $elm$json$Json$Decode$decodeString = _Json_runOnString;
var $author$project$Main$idbAdd = _Platform_outgoingPort(
	'idbAdd',
	function ($) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
...
var $author$project$Main$idbDelete = _Platform_outgoingPort(
	'idbDelete',
	function ($) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'uuid',
				$elm$json$Json$Encode$string(item.uuid)),
				_Utils_Tuple2(
				'name',
				...
				_Utils_Tuple2(
				'qty',
				$elm$json$Json$Encode$int(item.qty)),
				_Utils_Tuple2(
				'link',
				$elm$json$Json$Encode$string(item.link)),
				_Utils_Tuple2(
				'bomUuid',
				$elm$json$Json$Encode$string(item.bomUuid))
			]));
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'SelectBom':
				var bomName = msg.a;
				return $elm$core$Debug$log('BOM name:' + bomName)(
					_Utils_Tuple2(model, $elm$core$Platform$Cmd$none));
			case 'Recv':
				var recvData = msg.a;
				var _v1 = recvData.name;
				switch (_v1) {
					case 'boms':
						var decodedBoms = A2(
			...
			case 'AddNewItem':
				...
				var newItemModel = _Utils_update(
					item,
					{name: ''});
				...
				var newItem = _Utils_update(
					item,
					{
						...
						uuid: $danyx23$elm_uuid$Uuid$toString(newUuid)
					});
				return ((model.newItem.name !== '') && (!(!model.newItem.price))) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							currentSeed: newSeed,
							currentUuid: $elm$core$Maybe$Just(newUuid),
							newItem: newItemModel
						}),
					$author$project$Main$idbAdd(
						{
							contents: A2(
								$elm$json$Json$Encode$encode,
								0,
								$author$project$Main$itemEncoder(newItem)),
							name: 'items'
						})) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'AddNewBom':
				var bom = model.newBom;
				var newBomModel = _Utils_update(
					bom,
					{name: ''});
				var _v6 = A2($elm$random$Random$step, $danyx23$elm_uuid$Uuid$uuidGenerator, model.currentSeed);
				var newUuid = _v6.a;
				var newSeed = _v6.b;
				var newBom = _Utils_update(
					bom,
					{
						uuid: $danyx23$elm_uuid$Uuid$toString(newUuid)
					});
				return (model.newBom.name !== '') ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							currentSeed: newSeed,
				...
				var newItem = _Utils_update(
					item,
					{
						price: A2(
							$elm$core$Maybe$withDefault,
							0,
							$elm$core$String$toInt(itemPrice))
					});
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'InputBomName':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{newBom: newBom}),
					$elm$core$Platform$Cmd$none);
			case 'SelectBomListItem':
				var bom = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							selectedBom: $elm$core$Maybe$Just(bom)
						}),
					$elm$core$Platform$Cmd$none);
			case 'DeleteItem':
				var uuid = msg.a;
...
var $author$project$Main$InputItemName = function (a) {
	return {$: 'InputItemName', a: a};
};
var $author$project$Main$InputItemPrice = function (a) {
	return {$: 'InputItemPrice', a: a};
};
...
var $author$project$Main$SelectBomListItem = function (a) {
	return {$: 'SelectBomListItem', a: a};
};
...
var $author$project$Main$makeBomListItem = function (bom) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$SelectBomListItem(bom))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(bom.name)
					])),
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick(
						$author$project$Main$DeleteBom(bom.uuid))
					]),
				_List_fromArray(
					[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('A program to save and sum BOM lists in your browser storage')
							]))
					])),
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Select BOM')
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				A2($elm$core$List$map, $author$project$Main$makeBomListItem, model.boms)),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Add new BOM:'),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$placeholder('New BOM Name...'),
										$elm$html$Html$Attributes$value(model.newBom.name),
										$elm$html$Html$Events$onInput($author$project$Main$InputBomName),
								...
								_List_fromArray(
									[
										A2($elm$html$Html$Attributes$style, 'flex-grow', '1'),
										$elm$html$Html$Events$onClick($author$project$Main$AddNewBom)
									]),
								_List_fromArray(
									[
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Item List for ' + bom.name)
											]))
									])),
								A2(
								$elm$html$Html$div,
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Insert new Item...')
											])),
										A2(
										$elm$html$Html$div,
										_List_Nil,
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$placeholder('New Item Name...'),
														$elm$html$Html$Attributes$value(model.newItem.name),
														$elm$html$Html$Events$onInput($author$project$Main$InputItemName),
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$placeholder('Qty...'),
																$elm$html$Html$Attributes$value(
																$elm$core$String$fromInt(model.newItem.qty)),
																$elm$html$Html$Events$onInput($author$project$Main$InputItemQty),
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$type_('number'),
																$elm$html$Html$Attributes$placeholder('New Item Price/Unit...'),
																$elm$html$Html$Attributes$value(
																$elm$core$String$fromInt(model.newItem.price)),
																$elm$html$Html$Events$onInput($author$project$Main$InputItemPrice),
																A2($elm$html$Html$Attributes$style, 'width', '100%'),
																A2($elm$html$Html$Attributes$style, 'margin-left', '1em')
															]),
														_List_Nil)
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												A2($elm$html$Html$Attributes$style, 'width', '100%'),
												$elm$html$Html$Events$onClick($author$project$Main$AddNewItem)
											]),
										_List_fromArray(
											[
										...
										_Utils_ap(
											...
											A2(
												...
												A2(
													$elm$core$List$filter,
													function (item) {
														return _Utils_eq(item.bomUuid, bom.uuid);
													},
													model.items))))
									])),
								A2(
